...
<!--Container-->
    ...
    <?php
      $res = mysqli_query($main->construct(),"SELECT a.Title as 'TitleArt', a.Author, a.Content, a.Date,c.Title FROM articles as a inner join category as c on a.category_category_id = c.category_id where c.Title = 'LoL' order by idArticles desc limit 5 ");
