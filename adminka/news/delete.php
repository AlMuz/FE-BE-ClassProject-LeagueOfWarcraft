...
include("../../assets/php/delete_news.php");
$main = new DB_class();
$main->construct();
$main->check();
session_start();
...
<html lang="en">
  	<head>
	    ...
	    <title>Adminka - Delete News</title>
	    <!-- Bootstrap -->
  	...
  	<body>
	    <div class="container-fluid">
	          ...
	          <div class="navbar-header header">
	            ...
	            <div id="navbarCollapse" class="collapse navbar-collapse navbar-right">
	              ...
	              <ul class="nav nav-pills">
	                ...
	                <li w> <a href="update.php">Update News</a> </li>
	                <li class="active"> <a href="delete.php">Delete News</a> </li>
	      ...
	      <aside class = "col-md-2 hidden-xs">
	        ...
	        <main class="col-md-8 " >  
				<p class="text-center">Articles titles to delete:</p>
				<form action = "delete.php.php" method = "get">
					<?php
					delete_news();
					?>
